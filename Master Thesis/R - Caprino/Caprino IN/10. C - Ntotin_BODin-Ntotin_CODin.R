...
tsBODINtotal_original["2017-01-02"]<-NA #la riga sopra serve per rimuovere il dato
...
plot(as.zoo(rapportoN_BOD),type="n",xlab="Mesi",ylab=expression(paste("N"[tot-IN],"/BOD"[5-IN],", N"[tot-IN],"/COD"[IN]," [ - ]")),yaxt="n",xaxt="n",yaxs="i",xaxs="i",cex.lab=1.2,ylim=c(0,0.6),col="grey")
drawTimeAxis(as.zoo(tsBODINtotal_spazi), tick.tstep ="months", lab.tstep ="months",las=2,lab.fmt="%m")
axis(side=2,at=seq(from = 0,to = 0.6,by = 0.1),las=2,format(seq(from = 0,to = 0.6,by = 0.1), big.mark = ".", decimal.mark = ","))
...
text(x=index(tsBODIN2015[182,]),y=0.58,label="2015")
text(x=index(tsBODIN2016[182,]),y=0.58,label="2016")
text(x=index(tsBODIN2017[182,]),y=0.58,label="2017")
text(x=index(tsBODIN2018[90,]),y=0.58,label="2018")
legend(x=index(tsBODIN2015[30,]),y=0.55, c(expression(paste("N"[tot-IN],"/BOD"[5-IN])),expression(paste("MA N"[tot-IN],"/BOD"[5-IN]," (mensile)")),expression(paste("N"[tot-IN],"/COD"[IN])), expression(paste("MA N"[tot-IN],"/COD"[IN]," (mensile)"))),col=c("darkslategrey","black","orange","red"),lty=c(1,1,1,1),lwd=c(1,1,1,1),bg="white")
...
plot(as.zoo(rapportoN_BOD),type="n",xlab="Mesi",ylab=expression(paste("N"[tot-IN],"/BOD"[5-IN]," [ - ]")),yaxt="n",xaxt="n",yaxs="i",xaxs="i",cex.lab=1.2,ylim=c(0,0.7),col="grey")
drawTimeAxis(as.zoo(tsBODINtotal_spazi), tick.tstep ="months", lab.tstep ="months",las=2,lab.fmt="%m")
axis(side=2,at=seq(from = 0,to = 0.7,by = 0.1),las=2,format(seq(from = 0,to = 0.7,by = 0.1), big.mark = ".", decimal.mark = ","))
...
plot(as.zoo(rapportoN_COD),type="n",xlab="Mesi",ylab=expression(paste("N"[tot-IN],"/COD"[IN]," [ - ]")),yaxt="n",xaxt="n",yaxs="i",xaxs="i",cex.lab=1.2,ylim=c(0,0.3),col="grey")
drawTimeAxis(as.zoo(tsBODINtotal_spazi), tick.tstep ="months", lab.tstep ="months",las=2,lab.fmt="%m")
axis(side=2,at=seq(from = 0,to = 0.3,by = 0.1),las=2,format(seq(from = 0,to = 0.3,by = 0.1), big.mark = ".", decimal.mark = ","))
...
text(x=index(tsBODIN2015[182,]),y=0.285,label="2015")
text(x=index(tsBODIN2016[182,]),y=0.285,label="2016")
text(x=index(tsBODIN2017[182,]),y=0.285,label="2017")
text(x=index(tsBODIN2018[90,]),y=0.285,label="2018")
legend(x=index(tsBODIN2015[30,]),y=0.27, c(expression(paste("N"[tot-IN],"/COD"[IN])),expression(paste("MA N"[tot-IN],"/COD"[IN]," (mensile)")),expression(paste("Media N"[tot-IN],"/COD"[IN])),expression(paste("Min N"[tot-IN],"/COD"[IN]," liquame urbano")),expression(paste("Max N"[tot-IN],"/COD"[IN]," liquame urbano")),expression(paste("Tipico N"[tot-IN],"/COD"[IN]," liquame urbano"))), col=c("darkslategrey","black","blue","red","darkgreen","orange"),lty=c(1,1,1,1,1,1),lwd=c(1,1,2,2,2,2),bg="white")

# BOXPLOT
windows(width = 6,height = 6)
par(mar=c(1,6,4,4),mgp=c(4,1,0))

boxplot(coredata(rapportoN_BOD),yaxt="n",ylab="[ - ]",main=expression(paste("N"[tot-IN],"/BOD"[5-IN])), ylim=c(0,0.6),cex.lab=1.5,cex.main=2)
axis(side=2,at=seq(from = 0,to = 0.6,by = 0.1),las=2,labels = format(seq(from = 0,to = 0.6,by = 0.1), big.mark = ".", decimal.mark = ","))

windows(width = 6,height = 6)
par(mar=c(1,6,4,4),mgp=c(4,1,0))

boxplot(coredata(rapportoN_COD),yaxt="n",ylab="[ - ]",main=expression(paste("N"[tot-IN],"/COD"[IN])), ylim=c(0,0.3),cex.lab=1.5,cex.main=2)
axis(side=2,at=seq(from = 0,to = 0.3,by = 0.1),las=2,labels = format(seq(from = 0,to = 0.3,by = 0.1), big.mark = ".", decimal.mark = ","))
