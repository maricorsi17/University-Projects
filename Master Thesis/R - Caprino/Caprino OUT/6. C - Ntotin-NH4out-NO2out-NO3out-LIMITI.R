...
plot(as.zoo(tsNH4OUTtotal),as.zoo(tsNO2OUTtotal),xaxs="i",yaxt="n",xaxt="n",yaxs="i",xlab=expression(paste("N-NH"[4-IN]^"+"," [mg/L]")),ylab=expression(paste("N-NO"[2-IN]^"-"," [mg/L]")),cex.lab="1.2",xlim=c(0,25),ylim=c(0,25))
