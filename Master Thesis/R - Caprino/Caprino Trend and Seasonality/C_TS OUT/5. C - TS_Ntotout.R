...
plot(as.zoo(tsNtotINtotal),type="n",xlab="Mesi",ylab=expression(paste("N"[tot-OUT]," [mg/L]")),yaxt="n",xaxt="n",yaxs="i",xaxs="i",cex.lab=1.2,ylim=c(0,25),col="grey")
...
text(x=index(tsNtotIN2016[181,]),y=12.5, label=paste("Variazione = ",format(round(perc_a,digits=1),decimal.mark = ","),"%"),col="red")
legend(x=index(tsNtotIN2017[60,]),y=21, c(expression(paste("N"[tot-OUT])),"Regressione","LOESS"),col=c("darkslategrey","red","black"),lty=c(1,5,1),lwd=c(1,2,2),bg="white")
