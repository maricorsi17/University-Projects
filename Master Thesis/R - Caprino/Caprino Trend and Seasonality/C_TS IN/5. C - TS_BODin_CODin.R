...
text(x=index(tsBODIN2016[181,]),y=0.1, label=paste("Variazione = ",format(round(perc_a,digits=1),nsmall=1,decimal.mark = ","),"%"),col="red")
legend(x=index(tsBODIN2016[50,]),y=0.99, c(expression(paste("BOD"[5-IN],"/COD"[IN])),"Regressione","LOESS"),col=c("darkslategrey","red","black"),lty=c(1,5,1),lwd=c(1,2,2),bg="white")
