...
text(x=index(tsNtotIN2016[181,]),y=0.025, label=paste("Variazione = ",format(round(perc_a,digits=1),decimal.mark = ","),"%"),col="red")
legend(x=index(tsNtotIN2015[30,]),y=0.35, c(expression(paste("P"[tot-IN],"/N"[tot-IN])),"Regressione","LOESS"),col=c("darkslategrey","red","black"),lty=c(1,5,1),lwd=c(1,2,2),bg="white")
